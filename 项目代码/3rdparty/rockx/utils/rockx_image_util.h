 ...
 * @param mode [in] 0: keep src_rect size and only resize when large than roi_img size 1: resize to roi_img size; 
 * @return @ref rockx_ret_t
 */
rockx_ret_t rockx_image_roi_with_align_convert_prealloc(rockx_image_t* in_img, rockx_rect_t* src_rect, rockx_image_t* roi_img, rockx_rect_t* dst_rect, int mode);
