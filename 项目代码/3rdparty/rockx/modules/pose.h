...
extern rockx_module_t ROCKX_MODULE_POSE_FINGER;                 ///< Finger Landmark(3 KeyPoint)
 ...
 * @return rockx_ret_t 
 */
rockx_ret_t rockx_pose_body(rockx_handle_t handle, rockx_image_t* img, rockx_keypoints_array_t* body_array, int person_count);

/**
 * Get KeyPoint of A Human Hand
 *
 * @param handle [in] Handle of a created ROCKX_MODULE_POSE_FINGER module(created by @ref rockx_create)
