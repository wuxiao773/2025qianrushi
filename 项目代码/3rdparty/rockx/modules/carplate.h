...
extern rockx_module_t ROCKX_MODULE_CARPLATE_DETECTION;  ///< CarPlate Detection
extern rockx_module_t ROCKX_MODULE_CARPLATE_ALIGN;      ///< CarPlate Correct Alignment
extern rockx_module_t ROCKX_MODULE_CARPLATE_RECOG;      ///< CarPlate Recognition
 ...
 * "X", "Y", "Z", \n "港", "学", "使", "警", "澳", "挂", "军", "北", "南", "广", "沈", "兰", "成", "济", "海", "民",
 * "航", "空" \n
 */
